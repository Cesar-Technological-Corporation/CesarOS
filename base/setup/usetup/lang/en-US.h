...
{
    {
        4,
        3,
        " CesarOS " KERNEL_VERSION_STR " Setup ",
    ...
    },
    {
        0,
        20,
        "Please wait while the CesarOS Setup initializes itself",
...
static MUI_ENTRY enUSWelcomePageEntries[] =
{
    ...
    },
    {
        6,
        11,
        "This part of the setup copies the CesarOS Operating System to your",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        15,
        "\x07  Press ENTER to install or upgrade CesarOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        17,
     // "\x07  Press R to repair a CesarOS installation using the Recovery Console.",
        "\x07  Press R to repair a CesarOS installation.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        19,
        "\x07  Press L to view the CesarOS Licensing Terms and Conditions.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        21,
        "\x07  Press F3 to quit without installing CesarOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        23,
        "For more information on CesarOS, please visit:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        24,
        "https://cesartechcorp.org/cesaros",
        TEXT_STYLE_HIGHLIGHT,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSIntroPageEntries[] =
{
    ...
    },
    {
        6,
        11,
        "CesarOS is in Alpha stage, meaning it is not feature-complete",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        16,
        "to run CesarOS on real hardware.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        19,
        "\x07  Press ENTER to continue CesarOS Setup.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSLicensePageEntries[] =
{
    ...
    },
    {
        8,
        8,
        "The CesarOS System is licensed under the terms of the",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        11,
        "All software that is part of the CesarOS system is",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        17,
        "CesarOS only covers distribution to third parties.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        19,
        "GNU General Public License with CesarOS please visit",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSRepairPageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "CesarOS Setup is in an early development phase. It does not yet",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSUpgradePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "The CesarOS Setup can upgrade one of the available CesarOS installations",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        9,
        "listed below, or, if a CesarOS installation is damaged, the Setup program",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSQuitPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "CesarOS is not completely installed.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSSuccessPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "The basic components of CesarOS have been installed successfully.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSSelectPartitionEntries[] =
{
    ...
    },
    {
        8,
        13,
        "\x07  Press ENTER to install CesarOS onto the selected partition.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSChangeSystemPartition[] =
{
    ...
    },
    {
        6,
        16,
        "uses a format not supported by CesarOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        18,
        "In order to successfully install CesarOS, the Setup program must change",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        35,
        "to the original one after finishing the installation of CesarOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSConfirmDeleteSystemPartitionEntries[] =
{
    ...
    },
    {
        6,
        11,
        "programs, programs to start an operating system (like CesarOS) or other",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        17,
        "computer from the harddisk until you finished the CesarOS Setup.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSInstallDirectoryEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Setup installs CesarOS files onto the selected partition. Choose a",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        9,
        "directory where you want CesarOS to be installed:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        15,
        "characters and then type the directory where you want CesarOS to",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSFileCopyEntries[] =
{
    ...
    },
    {
        0,
        12,
        "Please wait while CesarOS Setup copies files to your CesarOS",
        TEXT_STYLE_NORMAL | TEXT_ALIGN_CENTER,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSPrepareCopyEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Setup prepares your computer for copying the CesarOS files.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
MUI_ERROR enUSErrorEntries[] =
{
    ...
    {
        // ERROR_NOT_INSTALLED
        "CesarOS is not completely installed on your\n"
        "computer. If you quit Setup now, you will need to\n"
        "run Setup again to install CesarOS.\n"
        "\n"
    ...
    {
        // ERROR_NO_BUILD_PATH
        "Failed to build the installation paths for the CesarOS installation directory!\n"
        "ENTER = Reboot computer"
    },
    {
        // ERROR_SOURCE_PATH
    ...
    {
        // ERROR_SOURCE_DIR
        "You cannot install CesarOS within the installation source directory!\n"
        "ENTER = Reboot computer"
    },
    {
        // ERROR_NO_HDD
    ...
    },
    {
        ...
        "The selected partition is not large enough to install CesarOS.\n"
...
MUI_STRING enUSStrings[] =
{
    ...
    "You chose to install CesarOS on a new or unformatted Partition."},
    {STRING_NONFORMATTEDSYSTEMPART,
    "The system partition is not formatted yet."},
    {STRING_NONFORMATTEDOTHERPART,
    "The new partition is not formatted yet."},
    {STRING_INSTALLONPART,
    "Setup installs CesarOS onto Partition"},
    {STRING_CONTINUE,
    "ENTER = Continue"},
    {STRING_QUITCONTINUE,
    "F3 = Quit  ENTER = Continue"},
